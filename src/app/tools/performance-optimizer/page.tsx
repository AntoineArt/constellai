...
export default function PerformanceOptimizerPage() {
  ...
  const toolHistory = useToolHistory(TOOL_IDS.PERFORMANCE_OPTIMIZER, {
    apiKey,
  });
  ...
  useEffect(() => {
    if (toolHistory.isLoaded && toolHistory.currentExecution) {
      ...
      if (execution.inputs?.includeBenchmarks !== undefined) {
        setIncludeBenchmarks(execution.inputs.includeBenchmarks);
      }
      if (execution.inputs?.includeProfiling !== undefined) {
        setIncludeProfiling(execution.inputs.includeProfiling);
      }
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (error instanceof Error && error.name === "AbortError") {
        ...
        setResult("Sorry, an error occurred while analyzing performance.");
        setStatus("error");
      }
    }
  }, [
  ...
  return (
    <div className="h-screen overflow-hidden flex">
      ...
      <ToolHistorySidebar
        ...
        toolName="Performance Optimizer"
      />

      {/* Main Content */}
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top bar */}
        <TopBar title="Performance Optimizer" />
                ...
                <CardContent className="p-6">
                  <form onSubmit={handleFormSubmit} className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor={codeId}>Code to Optimize</Label>
                      <Textarea
                        ref={textareaRef}
                        id={codeId}
                        value={code}
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder="Describe the application context, usage patterns, or performance requirements..."
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <Label
                            htmlFor={benchmarksId}
                            className="text-sm font-normal"
                          >
                            Include benchmarking recommendations and tools
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setIncludeProfiling(checked as boolean)
                            }
                            disabled={status === "streaming"}
                          />
                          <Label
                            ...
                            className="text-sm font-normal"
                          >
                            Include profiling guidance and performance
                            monitoring
                          </Label>
                        </div>
                      </div>
