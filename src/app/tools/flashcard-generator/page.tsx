...
export default function FlashcardGenerator() {
  ...
  const numberOfCardsId = useId();
  const examplesId = useId();

  const { addToHistory, getHistory } = useToolHistory(
    TOOL_IDS.FLASHCARD_GENERATOR
  );
  ...
  useEffect(() => {
    ...
    if (history.length > 0) {
      ...
      setCardType(lastExecution.inputs.cardType || "");
      setNumberOfCards(lastExecution.inputs.numberOfCards || "");
      setIncludeExamples(lastExecution.inputs.includeExamples ?? true);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch("/api/flashcard-generator", {
        method: "POST",
        headers: {
      ...
      if (error instanceof Error && error.name === "AbortError") {
        ...
        setResult("Error generating flashcards. Please try again.");
      }
    } finally {
      setIsLoading(false);
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Create effective study flashcards from your content.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Enter the content you want to create flashcards from..."
            ...
            <div className="space-y-2">
              ...
              <Select value={cardType} onValueChange={setCardType}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="term-definition">
                    Term & Definition
                  </SelectItem>
                  <SelectItem value="concept-explanation">
                    Concept & Explanation
                  </SelectItem>
            ...
            <div className="space-y-2">
              <Label htmlFor={numberOfCardsId}>Number of Cards</Label>
              <Input
                id={numberOfCardsId}
                value={numberOfCards}
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor={examplesId}>Include Examples</Label>
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your study flashcards will appear here.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {result ? (
              ...
              <div className="text-center text-muted-foreground py-8">
                ...
                <p>
                  Fill in the form and click "Generate Flashcards" to get
                  started.
                </p>
              </div>
            )}
