...
export default function StyleGuideGeneratorPage() {
  const { hasApiKey, apiKey } = useApiKey();
  const toolHistory = useToolHistory(TOOL_IDS.STYLE_GUIDE_GENERATOR, {
    apiKey,
  });
  ...
  const comprehensiveGuidelinesId = useId();
  ...
  const [includeComprehensiveGuidelines, setIncludeComprehensiveGuidelines] =
    useState(true);
  ...
  useEffect(() => {
    if (toolHistory.isLoaded && toolHistory.currentExecution) {
      ...
      if (execution.inputs?.includeComprehensiveGuidelines !== undefined) {
        setIncludeComprehensiveGuidelines(
          execution.inputs.includeComprehensiveGuidelines
        );
      }
  ...
  const clearForm = useCallback(() => {
    ...
    setIncludeComprehensiveGuidelines(true);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch("/api/style-guide-generator", {
        method: "POST",
        headers: {
      ...
      if (error instanceof Error && error.name === "AbortError") {
        ...
        setResult("Sorry, an error occurred while generating style guide.");
        setStatus("error");
      }
    }
  }, [
  ...
  return (
    <div className="h-screen overflow-hidden flex">
      ...
      <ToolHistorySidebar
            ...
            await toolHistory.createNewExecution(
              {
                ...
                includeComprehensiveGuidelines: true,
        ...
        toolName="Style Guide Generator"
      />

      {/* Main Content */}
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top bar */}
        <TopBar title="Style Guide Generator" />
                ...
                <CardContent className="p-6">
                  <form onSubmit={handleFormSubmit} className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <Label>Style Guide Options</Label>
                      <div className="flex flex-col gap-2">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            id={comprehensiveGuidelinesId}
                            checked={includeComprehensiveGuidelines}
                          ...
                          />
                          <Label
                            htmlFor={comprehensiveGuidelinesId}
                            className="text-sm font-normal"
                          >
                            Include comprehensive brand guidelines
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
